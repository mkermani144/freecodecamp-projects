...
class Login extends Component {
  ...
  handleSubmit = async (e) => {
    ...
    if (response.ok) {
      ...
      json.polls.forEach(poll => this.props.addPoll(poll.id, this.state.username, poll.title, poll.description, Object.keys(poll.choices).map(key => [key, poll.choices[key]])));
